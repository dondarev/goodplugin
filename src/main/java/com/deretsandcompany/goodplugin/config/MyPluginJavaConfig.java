package com.deretsandcompany.goodplugin.config;

import com.deretsandcompany.goodplugin.api.MyPluginComponent;
import com.deretsandcompany.goodplugin.impl.MyPluginComponentImpl;
...
public class MyPluginJavaConfig {
    ...
    @Bean
    public ReportContextLeadTime getReportCOntext(){
        return new ReportContextLeadTime();
    }
}